  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-transparent text-foreground hover:bg-muted hover:border-border active:scale-[0.98]",
        secondary:
        ...
        hero:
          "bg-gradient-primary text-primary-foreground shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-0.5 active:translate-y-0 active:shadow-md",
        // Hero secondary - glass effect
        "hero-secondary":
          "bg-surface/80 backdrop-blur-sm border border-border text-foreground shadow-sm hover:bg-surface hover:shadow-md hover:-translate-y-0.5 active:translate-y-0",
        // Accent variant
        accent:
