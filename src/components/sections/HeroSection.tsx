...
export function HeroSection() {
  ...
  const cardVariants = {
    hidden: { opacity: 0, y: 30, rotateX: shouldReduceMotion ? 0 : -10 },
    visible: (i: number) => ({
      opacity: 1,
      y: 0,
      rotateX: 0,
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative perspective-1000">
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="absolute -top-4 -left-4 lg:-left-8 w-[280px] z-10"
            >
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="relative z-20 mx-auto w-full max-w-[340px] lg:ml-16"
            >
              <div className="rounded-2xl bg-surface border border-border shadow-2xl overflow-hidden">
                ...
                <div className="p-5 bg-background-subtle dark:bg-surface-elevated">
                  ...
                  <div className="space-y-3">
                    {[
                      { task: "Review Chapter 5 notes", time: "9:00 AM", done: true },
                      { task: "Complete Math Problem Set", time: "2:00 PM", done: false },
                      { task: "Submit Essay Draft", time: "5:00 PM", done: false },
                    ].map((item, i) => (
                      <motion.div
                        key={item.task}
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="absolute -bottom-6 -right-4 lg:-right-8 w-[260px] z-30"
            >
              <div className="rounded-2xl bg-surface border border-border shadow-xl p-4">
                <div className="flex items-center gap-2 mb-3">
