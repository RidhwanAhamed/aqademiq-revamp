...
const features = [
  {
    ...
    benefits: [
      ...
      "Energy-aware task placement based on your patterns",
      "LMS integration for automatic deadline import",
    ],
    color: "primary",
    visual: "calendar",
  },
  {
    ...
    benefits: [
      ...
      "Smart task breakdown for complex assignments",
...
const additionalFeatures = [
  { icon: Smartphone, title: "Mobile-First PWA", description: "Works offline, installs on any device" },
  { icon: RefreshCw, title: "Real-time Sync", description: "Seamless updates across all platforms" },
  { icon: Shield, title: "Privacy First", description: "Your data stays yours, encrypted and secure" },
  { icon: Bell, title: "Smart Reminders", description: "Contextual notifications that help, not annoy" },
];
